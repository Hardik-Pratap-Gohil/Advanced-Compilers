...
public class ClassResource {
    ...
    public void addMethod(String name, Map<String, String> args, String originClass) {
        methodMetadata.put(name, new MethodMetadata(name, args, originClass)); // Override any existing method
    }


    // Add method metadata directly
    public void addMethodMetadata(String name, Map<String, String> args, String originClass) {
        methodMetadata.put(name, new MethodMetadata(name, args, originClass));
    }
